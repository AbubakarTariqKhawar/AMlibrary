                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                      <h4 class="mb-0">Card details</h4>
                              ...
                              <div class="form-white mb-4 ml-0 col-md-4 " >
                                <button class="btn btn-block  " style="min-height: calc(1.5em + 1rem + calc(var(--bs-border-width) * 2));height: calc(2.875rem + 2px);    ">add card</button>
                              </div>
                              </div>
                    ...
                    <form class="mt-4">
                      ...
                      <div class="form-outline form-white mb-4">
                        ...
                        <input type="text" id="typeText" class="form-control form-control-lg" siez="17"
                          placeholder="1234 NW Bobcat Lane, St. Robert" minlength="19" maxlength="19" />
                    ...
                    <div class="form-white mb-4 ml-0 col-md-4 " >
                      <button class="btn btn-block  " style="min-height: calc(1.5em + 1rem + calc(var(--bs-border-width) * 2));height: calc(2.875rem + 2px);     ">add address</button>
                    </div>
                    </div>
                    </form>
