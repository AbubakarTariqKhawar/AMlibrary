...
<footer id="footer" class="footer-1">
    <div class="main-footer widgets-dark typo-light">
        <div class="container">
            ...
            <h5 class="widget-title"><img src="../logo/amlogow1footer.svg" alt="AMLibrary" style="height: 40px;"><span></span></h5>
            <p>About AMLibrary, AMLibrary is a digital platform that provides <br> access to a vast collection of books.</p>
            </div>
            </div>
            ...
            <p><a href="mailto:info@domain.com" title="glorythemes">AMLibrary@gmail.com</a></p>
            ...
            <p>Copyright AMLibrary © 2023. All rights reserved.</p>
            </div>
            </div>
        </div>
    </div>
